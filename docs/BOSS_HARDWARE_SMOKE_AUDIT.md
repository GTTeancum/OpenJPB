...
Contact sheet manifest: `C:\Programming\GitHub\Jedi Power Battles recomp\out\boss-smoke-hardware\contact-sheet.manifest.json`.
...
- FED droid fighter: High-hp authored droid-fighter placement near the FED boss arena; spawn uses the linked trigger cluster so the player stays alive and visible. Console: `C:\Programming\GitHub\Jedi Power Battles recomp\out\boss-smoke-hardware\fed-droid-fighter.console.txt`. Raw frame path during run: `C:\Programming\GitHub\Jedi Power Battles recomp\out\boss-smoke-hardware\fed-droid-fighter.ppm`; file pruned after contact-sheet generation.
...
Raw JSON: `C:\Programming\GitHub\Jedi Power Battles recomp\out\boss-smoke-hardware\results.json`.
